        ...
        <div class="column">
          ...
          >
            ...
            <dl>
              ...
              <dd>[Définition AG]<br>
                Inclut : Cardinaux, Légats, Conciles</dd>

              <dt>Évêque et entourage</dt>
              <dd>[Définition AG]<br>
                Inclut : Archevêques, Chapitre cathédral et ses dignitaires, synodes diocésains et provinciaux, vicaire, official, archidiacres, doyens de chrétienté, curés (hors juridiction gracieuse)</dd>

              <dt>Religieux</dt>
              <dd>[Définition AG]<br>
                Dignitaires et membres de maisons religieuses et d’ordres</dd>
              ...
              <dd>[Définition AG]<br>
                Inclut : juridiction gracieuse (écrits d’arche, etc.)</dd>

              <dt>Actes privés, Système traditionnels</dt>
              <dd>[Définition AG]<br>
                Vise les actes du haut Moyen Âge, toutes solutions confondues : notariat vieux style, chartes et notices du notaire villageois comme du notaire-juge, notice monastique…</dd>
            ...
            <dl>
              ...
              <dd>[Définition AG]<br>
                Biens fonciers et mobiliers, trésors, archives, bibliothèques</dd>
              ...
              <dd>[Définition AG]<br>
                ...
                Ces documents sont dits « propres » pour bien marquer qu’ils ne sont pas « relatifs » à un domaine d’activité, mais que leur production est intrinsèquement liée à celui-ci. On en donne quelques exemples entre crochets droits. Inclut : Banque, monnaie, agriculture, pêche…</dd>
