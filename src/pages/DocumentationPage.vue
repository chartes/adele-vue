      ...
      <div class="columns main-columns">
        ...
        <div class="column content-column">
          ...
          >
            ...
            <p>
              La situation, paradoxalement, ne s’est guère améliorée aux temps du numérique et surtout des hauts et très hauts débits, où le flot des images d’archives, qui s’en trouvent mieux préservées et plus facilement communiquées, reste mal domestiqué, avec des possibilités de recherche et de tri souvent réduites et un apparat quasi inexistant, même pour des réalisations aussi superbes que le site des archives de Saint-Maurice d’Agaune ou la colossale entreprise <a href="https://www.icar-us.eu/cooperation/online-portals/monasterium-net/" target="_blank">Monasterium.net</a>, pour se limiter à deux exemples.
            </p>
            <p>
            ...
            <p>
              Cette architecture a été imaginée, testée, mise au point à l’École nationale des chartes dans le cadre de l’application THELEME (Techniques pour l’historien en ligne), qui fait maintenant figure de prototype, sans indexation et où les premiers dossiers, de paléographie, conçus par Marc Smith, ont été progressivement flanqués de dossiers diplomatiques, préparés par les étudiants des cours de diplomatique médiévale puis de diplomatique moderne (dir. Olivier Guyotjeannin et Olivier Poncet ; vue d’ensemble des dossiers consultables dans <a href="http://theleme.enc.sorbonne.fr/dossiers/" target="_blank">http://theleme.enc.sorbonne.fr/dossiers/</a>). Le premier de ces dossiers de diplomatique a été publié sur le site de l’École des chartes en 2001 (<a href="http://theleme.enc.sorbonne.fr/dossiers/notice20.php" target="_blank">http://theleme.enc.sorbonne.fr/dossiers/notice20.php</a>). Ils sont aujourd’hui au nombre de 89, étagés du IX<sup>e</sup>  au XVIII<sup>e</sup> siècle.
            </p>
            <p>
