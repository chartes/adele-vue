<template>
  <div v-if="!isTranscriptionReadOnly" class="edition-action-bar m-b-md">
    <div class="field is-grouped">
      ...
      <p
        v-if="
          currentSection === 'transcription' &&
          (currentUserIsTeacher || !isTranscriptionReadOnly)
        "
        class="control"
      >
        <delete-transcription-button :doc-id="document.id" :user-id="selectedUserId" />
      </p>
    </div>
  </div>
</template>
